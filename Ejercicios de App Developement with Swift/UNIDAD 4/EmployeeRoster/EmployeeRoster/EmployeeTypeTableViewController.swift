...
class EmployeeTypeTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "EmplooyeTypeCell", for: indexPath)
        let type = EmployeeType.all[indexPath.row]

        // Configure the cell...
        cell.textLabel?.text = type.description()
        
        if emplooyeType == type {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        emplooyeType = EmployeeType.all[indexPath.row]
        delegate?.didSelect(emplooyeType: emplooyeType!)
